function phow_caltech101_Spatial()
...
figure(1); clf;
plot(x,aca)
title('PHOW performance vs Num Spatial')
xlabel('Num Spatial')
ylabel('Performance (ACA)')
[M,I]=max(aca);
fprintf('The optimum number of Num Spatial is %f with an ACA of %f',I,M)
saveas(gcf,'ACAvNumSpatial.png')
